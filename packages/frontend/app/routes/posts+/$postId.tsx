        ...
        <div className="w-full">
            <div className="flex justify-center">
                <div className="w-full">
                    ...
                    <Spacer size="sm" />
                    <div className="flex justify-center">
                    <img src={`${STRAPI_BASE_URL}${data.data.attributes.Hero.data.attributes.formats.small.url}`} className="max-w-screen-md w-full rounded-md"/>
                    </div>
            ...
            return (
                <div className="h-full w-full flex justify-center items-center">
                    <div>
                        ...
                        <Spacer size="4xs" />
                        <Button variant="outline" asChild ><Link to="/">Go back Home</Link></Button>
                    </div>
                </div>
            )
        }
